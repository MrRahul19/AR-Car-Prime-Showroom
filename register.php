...
<body>
        ...
        <div class="right">
            <div class="formBox">
                <form action="register.php" method="POST">
                    ...
                    <input type="text" id="username" name="username" name="" placeholder="&nbsp; &nbsp; &nbsp; &nbsp;Enter Your Name">

                    <label for="city">City:</label>
                    <input type="text" id="city" name="city" name="" placeholder="&nbsp; &nbsp; &nbsp; &nbsp;Enter City Name">

                    <div class="intvalues">
                        <label for="contact">Contact:</label>
                        <input type="int" id="contact" name="contact" placeholder=" &nbsp; &nbsp;Contact No">
    ...
    <div class="title">
        <h3>Register to Go ar prime Showroom</h3>
        <a href="index.php"><h2><i class="fas fa-caret-left"></i>Back To Home </h2></a>
    </div>
</body>
</html>
