...
<head>
    ...
    <div class="header">
        ...
        <div class="connect-db">
            ...
            <div class="user">
                <h4><i class="fa fa-user-circle"></i> <?php echo htmlspecialchars($username); ?>!</h4><br>
    ...
    <div id="box1" class="box">
        ...
        <div class="Regular_Services">
            ...
            <div class="left-side">
                <img src="Cars-IMG/regular-services.png" alt="regular-services">
...
<div id="box2" class="box">
    ...
    <div class="Regular_Services">
        <div class="left-side">
            <img src="Cars-IMG/repaird-cars.png" alt="Accident Repair">
...
<div id="box3" class="box">
    ...
    <div class="Regular_Services">
        <div class="left-side">
            <img src="Cars-IMG/Extended-Warranty.png" alt="Extended Warranty">
            <p>Accident repair services include fixing body damage, dent removal, repainting, and replacing damaged parts to restore the car's original condition. 
                The service ensures safety checks on key components like brakes, suspension, and airbags after repairs.
                Vehicles are repaired at our workshops, equipped with the best facilities, qualified and trained manpower and Maruti Genuine spare parts.
            </p>
...
<div id="box4" class="box">
    ...
    <div class="Regular_Services">
        <div class="left-side">
            <img src="Cars-IMG/Insurance.png" alt="Insurance">
...
<div id="box5" class="box">
    ...
    <div class="Regular_Services">
        <div class="left-side">
            <img src="Cars-IMG/test-drive.png" alt="Test Drive">
...
<div id="box6" class="box">
    ...
    <div class="Regular_Services">
        <div class="left-side">
            <img src="Cars-IMG/pickup-drop.png" alt="Pick & Drop">
...
<div id="box7" class="box">
    ...
    <div class="Regular_Services">
        <div class="left-side">
            <img src="Cars-IMG/career-job.png" alt="Career/Job">
